  ...
  en: {
    translation: {
      ...
      overview: {
        ...
        popular_search_queries: "Popular Search Queries",
        page: "Page",
        views: "Views",
      ...
      notifications: {
        ...
        weekly_report_desc: "Receive a weekly summary of your website's performance.",
        traffic_drop: "Sudden Traffic Drop",
        traffic_drop_desc: "Get notified when traffic drops by more than 20% compared to previous periods.",
        goal_completion: "Goal Completion",
        goal_completion_desc: "Receive an alert when a user completes a predefined goal (e.g., checkout).",
        active: "Active",
        paused: "Paused",
  ...
  uk: {
    translation: {
      ...
      overview: {
        ...
        popular_search_queries: "Популярні пошукові запити",
        page: "Сторінка",
        views: "Перегляди",
      ...
      notifications: {
        ...
        test_email: "Тестовий Email",
        weekly_report: "Щотижневий звіт",
        weekly_report_desc: "Отримуйте щотижневий підсумок ефективності вашого сайту.",
        traffic_drop: "Раптове падіння трафіку",
        traffic_drop_desc: "Отримуйте сповіщення, коли трафік падає більше ніж на 20% порівняно з попередніми періодами.",
        goal_completion: "Досягнення мети",
        goal_completion_desc: "Отримуйте сповіщення, коли користувач досягає попередньо визначеної цілі.",
        active: "Активне",
        paused: "Вимкнене",
